            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form action="{{ route('admin.settings.header.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- Title Section --}}
                        <h5 class="mb-3 text-dark">Hero Title</h5>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="title_id" name="title[id]"
                                    value="{{ $header->title['id'] ?? '' }}" placeholder="Kesehatan Anda, Prioritas Kami">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="title_en" name="title[en]"
                                    value="{{ $header->title['en'] ?? '' }}" placeholder="Your Health, Our Priority">
                            </div>
                        </div>

                        {{-- Tagline Section --}}
                        <h5 class="mb-3 text-dark">Hero Tagline</h5>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <label for="tagline_id" class="form-label fw-bold text-muted">Tagline (Bahasa
                                    Indonesia)</label>
                                <textarea class="form-control" id="tagline_id" name="tagline[id]"
                                    rows="3">{{ $header->tagline['id'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="tagline_en" class="form-label fw-bold text-muted">Tagline (English)</label>
                                <textarea class="form-control" id="tagline_en" name="tagline[en]"
                                    rows="3">{{ $header->tagline['en'] ?? '' }}</textarea>
                            </div>
                            {{-- Button Section --}}
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    <label for="button_text_id" class="form-label fw-bold text-muted">Button Text
                                        (ID)</label>
                                    <input type="text" class="form-control" id="button_text_id" name="button_text[id]"
                                        value="{{ $header->button_text['id'] ?? '' }}" placeholder="Buat Janji Temu">
                                </div>
                                <div class="col-md-4">
                                    <label for="button_text_en" class="form-label fw-bold text-muted">Button Text
                                        (EN)</label>
                                    <input type="text" class="form-control" id="button_text_en" name="button_text[en]"
                                        value="{{ $header->button_text['en'] ?? '' }}" placeholder="Book Appointment">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="button_url" name="button_url"
                                        value="{{ $header->button_url ?? '' }}" placeholder="https://wa.me/...">
                                </div>
                            </div>

                            {{-- Logo Section --}}
                            <h5 class="mb-3 text-dark">Logo</h5>
                            <div class="mb-4">
