...
<head>
    ...
    <title>{{ config('app.name', 'Legian Medical Clinic') }} - Register</title>
...
<body class="d-flex align-items-center justify-content-center p-3 p-md-4">
    ...
    <div class="card card-auth w-100" style="max-width: 900px;">
        <div class="row g-0">
            <!-- Left Side: Branding -->
            <div
                ...
                <div class="position-relative z-1">
                    <div class="bg-white bg-opacity-10 rounded-circle d-inline-flex align-items-center justify-content-center mb-4"
                        ...
                        <img src="{{ asset('img/lmc.png') }}" alt="Logo" style="height: 60px;">
                    </div>
            ...
            <div class="col-lg-7 p-4 p-md-5">
                <div class="mx-auto" style="max-width: 400px;">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted small">Join us! Please fill in your details.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name') }}"
                                    class="form-control input-with-icon py-2 @error('name') is-invalid @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="position-relative">
                                ...
                                <input id="password_confirmation" type="password" name="password_confirmation"
                                    class="form-control input-with-icon py-2" placeholder="Confirm your password"
                                    required autocomplete="new-password">
                            </div>
                        </div>

                        <!-- Submit Button -->
                        <button type="submit" class="btn btn-brand text-white w-100 py-2 fw-bold mb-3">
                            {{ __('Register') }}
                        </button>
                        ...
                        <div class="text-center">
                            ...
                            <a class="link-primary-custom small fw-medium ms-1" href="{{ route('login') }}">
                                {{ __('Login') }}
                            </a>
                        </div>
                    </form>
