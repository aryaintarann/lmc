            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3 p-md-5 bg-soft">
                    ...
                    <div class="d-grid gap-3" style="max-width: 450px; margin: 0 auto;">
                        ...
                        <a href="{{ $emergencyUrl }}" target="_blank" class="btn choice-btn d-flex align-items-center justify-content-between" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); border-color: #dc3545;">
                            <div class="d-flex align-items-center gap-3">
                                <div class="rounded-circle text-white d-flex align-items-center justify-content-center flex-shrink-0" style="width: 60px; height: 60px; background: rgba(255, 255, 255, 0.2);">
                                    <i class="bi bi-telephone-fill fs-4"></i>
                                </div>
                                <div>
                                    <span class="d-block fw-bold text-white">{{ __('Emergency Call') }}</span>
                                    <small class="text-white-50" style="font-size: 0.75rem;">{{ __('Contact us immediately') }}</small>
                                </div>
                            </div>
